...
#' @param resn Parent residue name as 3-letter code (e.g. "ALA", "GLY", "CYS"...)
...
#' @param expand Expand selection to include atoms within a specified distance from current selection.
